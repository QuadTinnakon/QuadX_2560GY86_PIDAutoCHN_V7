...
//////////////////////////////////////////////////////////////////////
//P-PID-------------Rate
float Kp_rateRoll = 1.08;//2.78 1.18 5.28
float Ki_rateRoll = 0.82;//2.75
float Kd_rateRoll = 0.075;//0.085 0.025 - 0.045

float Kp_ratePitch = 1.08;//1.18 5.28
float Ki_ratePitch = 0.82;//2.75 0.5 - 2.8
float Kd_ratePitch = 0.075;//0.078 0.025 - 0.045
...
float Ka_altitude = 20.5;//32.5 38.5 41.5 35 25 - 45
